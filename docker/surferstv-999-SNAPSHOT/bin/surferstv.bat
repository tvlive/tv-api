@REM surferstv launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SURFERSTV_config.txt found in the SURFERSTV_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%SURFERSTV_HOME%"=="" set "SURFERSTV_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%SURFERSTV_HOME%\lib\"
...
set "CFG_FILE=%SURFERSTV_HOME%\SURFERSTV_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running surferstv.
  echo.
