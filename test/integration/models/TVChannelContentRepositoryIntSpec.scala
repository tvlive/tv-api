...
class TVChannelContentRepositoryIntSpec extends PlaySpec with MustMatchers with BeforeAndAfter with ScalaFutures with MongoSugar {
  ...
  val p1 = TVProgram("channel1", current.minusHours(4), current.minusHours(2), Some(List("documentary", "ENTERTAINMENT")), Some(Series("serie1", "ep1", None, None, None, None, Some(List("actor1")))), Some(Film("program1", None, Some(List("actor2")), Some("2011"))))
  val p2 = TVProgram("channel1", current.minusHours(2), current, Some(List("documentary")), Some(Series("serie2", "ep1", None, None, None, None, Some(List("actor1")))), Some(Film("program1", None, Some(List("actor2")), Some("2013"))))
  val p3 = TVProgram("channel1", current, current.plusHours(1), Some(List("FILM", "ENTERTAINMENT")), Some(Series("serie3", "ep1", None, None, None, None, Some(List("actor3")))), Some(Film("program1", None, Some(List("actor5")), Some("1999"))))
  val p4 = TVProgram("channel1", current.plusHours(1), current.plusHours(3), Some(List("documentary")), Some(Series("serie4", "ep1", None, None, None, None, Some(List("actor1")))), Some(Film("program1", None, Some(List("actor1")), None)))
  val p5 = TVProgram("channel1", current.plusHours(3), current.plusHours(5), Some(List("documentary")), Some(Series("serie5", "ep1", None, None, None, None, Some(List("actor1")))), Some(Film("program1", None, Some(List("actor5")), Some("2011"))))
  val p6 = TVProgram("channel1", current.plusHours(5), current.plusHours(7), Some(List("documentary")), Some(Series("serie6", "ep1", None, None, None, None, Some(List("actor6")))), Some(Film("program1", None, Some(List("actor1")), None)))
