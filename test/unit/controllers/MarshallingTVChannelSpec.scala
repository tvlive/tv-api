  ...
  "Write and reads" should {
    "transform TVChannel object to json" in {
      Json.toJson(TVChannel("bbc1",
        ...
        Some(id)))
        .toString() mustBe
        s"""{"name":"bbc1","provider":["provider1"],"category":["cat1"],"id":\"$idString\","uriToday":"/tvcontent/channel/bbc1/today","uriCurrent":"/tvcontent/channel/bbc1/current","uriLeft":"/tvcontent/channel/bbc1/left"}"""
    }
    ...
    "transform json to TVChannel object" in {
      Json.parse(
        s"""{"name":"bbc1",
           ...
           |"uriLeft":"/tvcontent/channel/bbc1/left"}""".stripMargin)
